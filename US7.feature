...
Given   El usuario ha accedido a una receta que ha pasado solo por el primer filtro de verificación por la Inteligencia Artificial (IA) 
And     Fue subida al foro como no verificada por un nutricionista.
When    El usuario lee la receta y prepara el plato.
Then    El sistema muestra la opción de comentar y calificar la receta, lo que permite al usuario compartir 
        su experiencia y/o realizar sugerencias respecto a la receta, así como compartir fotos del plato final.
...
Given   El usuario ha accedido a una receta que ha pasado el segundo filtro de verificación por un nutricionista 
...
Given   El usuario ha accedido a una receta en el foro.
